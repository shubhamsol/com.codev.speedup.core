...
namespace deVoid.UIFramework
{
    ...
    public class UIFrame : MonoBehaviour
    {
        ...
        /// </summary>
        public Canvas MainCanvas => mainCanvas ?? (mainCanvas = GetComponent<Canvas>());
        ...
        public virtual void Initialize() {
            if (panelLayer == null) {
                panelLayer = GetComponentInChildren<PanelUILayer>(true);
                if (panelLayer == null) {
            ...
            if (windowLayer == null) {
                windowLayer = GetComponentInChildren<WindowUILayer>(true);
                if (windowLayer == null) {
        ...
        public void ShowPanel(string screenId) => panelLayer.ShowScreenById(screenId);
        ...
        /// </summary>
        /// <param name="screenId">Identifier.</param>
        public void HidePanel(string screenId) => panelLayer.HideScreenById(screenId);

        /// <summary>
        /// Opens the Window with the given Id, with no Properties.
        /// </summary>
        /// <param name="screenId">Identifier.</param>
        public void OpenWindow(string screenId) => windowLayer.ShowScreenById(screenId);

        /// <summary>
        /// Closes the Window with the given Id.
        /// </summary>
        /// <param name="screenId">Identifier.</param>
        /// <param name="animate">Should the window animate while closing?</param>
        public void CloseWindow(string screenId, bool animate = true) => windowLayer.HideScreenById(screenId, animate);
        ...
        public void CloseCurrentWindow(bool animate = true) {
            if (windowLayer.CurrentWindow != null) {
                windowLayer.HideScreen(windowLayer.CurrentWindow, animate);
            }
        }
        ...
        public void ShowScreen(string screenId) {
            if (IsScreenRegistered(screenId, out var type)) {
                ...
                Debug.LogError($"Tried to open Screen id {screenId} but it's not registered as Window or Panel!");
            }
        }
        ...
        public bool IsPanelOpen(string panelId) => panelLayer.IsPanelVisible(panelId);

        /// <summary>
        /// Checks if a given Window is open.
        /// </summary>
        /// <param name="windowId">Window identifier.</param>
        public bool IsWindowOpen(string windowId) => windowLayer.CurrentWindow != null && windowLayer.CurrentWindow.ScreenId == windowId;
        ...
        /// </summary>
        /// <param name="animate">Defines if screens should the screens animate out or not.</param>
        public void HideAllPanels(bool animate = true) => panelLayer.HideAll(animate);

        /// <summary>
        /// Hide all screens in the Window Layer
        /// </summary>
        /// <param name="animate">Defines if screens should the screens animate out or not.</param>
        public void CloseAllWindows(bool animate = true) => windowLayer.HideAll(animate);

        /// <summary>
        /// Checks if a given screen id is registered to either the Window or Panel layers
        /// </summary>
        /// <param name="screenId">The Id to check.</param>
        public bool IsScreenRegistered(string screenId) => windowLayer.IsScreenRegistered(screenId) || panelLayer.IsScreenRegistered(screenId);
